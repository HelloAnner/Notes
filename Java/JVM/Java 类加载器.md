...
/**
 * Create by anner on 2022/9/13
 */
public class DemoClassloader extends ClassLoader {

    private final String path;

    public DemoClassloader(String path) {
        this.path = path;
    }
...
-   [http://gityuan.com/2016/01/24/java-classloader/open in new window](http://gityuan.com/2016/01/24/java-classloader/)